...
with st.form("settings_form"):
     noti = st.toggle(label="Recieve Notification", value=st.session_state["notification"], key="notification")
     sound = st.slider("Volume", min_value=0, max_value=100, value=st.session_state["sound"], key="sound")
